...
import { Printer, ArrowLeft, Download, Home, Droplet, Calendar, User, CreditCard } from 'lucide-react';
...
const WaterBill = () => {
  ...
  const [bill, setBill] = useState({
    ...
    dueDate: "10/12/2025",
    previousReading: 45, // m³
    currentReading: 52, // m³
    consumption: 7, // m³
    unitPrice: 15000, // VND/m³
    subtotal: 105000,
    serviceFee: 5000,
    total: 110000,
    paymentStatus: "Chưa thanh toán",
    paymentMethod: "",
    meterNumber: "WM78901234"
  });
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden mb-6">
            ...
            <div className="bg-blue-600 text-white p-6">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  <h1 className="text-2xl font-bold mb-1">HÓA ĐƠN TIỀN NƯỚC</h1>
                  <p className="text-blue-100">Chung cư mini HOME CONVENIENT</p>
                </div>
                <div className="text-left md:text-right">
                  <p className="text-blue-100">Mã hóa đơn: <span className="font-medium">WT-202311-201</span></p>
            ...
            <div className="p-6 border-b">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold">{bill.previousReading} <span className="text-sm font-normal">m³</span></p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="text-sm text-gray-500 mb-1">Chỉ số mới</h3>
                  <p className="text-2xl font-bold">{bill.currentReading} <span className="text-sm font-normal">m³</span></p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="text-sm text-gray-500 mb-1">Lượng tiêu thụ</h3>
                  <p className="text-2xl font-bold text-blue-600">{bill.consumption} <span className="text-sm font-normal">m³</span></p>
                </div>
              </div>
              <div className="mt-4 text-sm text-gray-600">
                <p>Mã đồng hồ: {bill.meterNumber}</p>
              </div>
            </div>
            ...
            <div className="p-6 border-b">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full">
                  ...
                  <tbody>
                    <tr>
                      <td className="px-4 py-3 border-b">Tiền nước ({bill.consumption}m³)</td>
                      <td className="px-4 py-3 border-b text-right">{bill.unitPrice.toLocaleString('vi-VN')} đ/m³</td>
                      <td className="px-4 py-3 border-b text-right">{bill.consumption} m³</td>
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 border-b text-right">-</td>
                      <td className="px-4 py-3 border-b text-right">-</td>
                      <td className="px-4 py-3 border-b text-right font-medium">{bill.serviceFee.toLocaleString('vi-VN')} đ</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-3">Phí trễ hạn</td>
                      <td className="px-4 py-3 text-right">-</td>
                      <td className="px-4 py-3 text-right">-</td>
                      <td className="px-4 py-3 text-right font-medium">0 đ</td>
                    </tr>
                  </tbody>
          ...
          <div className="p-4 bg-blue-50 rounded-lg text-sm text-blue-800">
            ...
            <ul className="list-disc pl-5 mt-1 space-y-1">
              ...
              <li>Mọi thắc mắc về chỉ số nước vui lòng liên hệ quản lý tòa nhà</li>
              <li>Đơn giá nước: {bill.unitPrice.toLocaleString('vi-VN')} đ/m³ (theo quy định của công ty cấp nước)</li>
            </ul>
          </div>
        </div>
      </div>
