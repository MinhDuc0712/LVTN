...
function Posts() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:flex-row md:p-6">
      ...
      <div className="w-full overflow-auto rounded-2xl border border-gray-100 bg-white p-6 shadow-xl">
        {/* Header */}
        <div className="mb-8">
          ...
          <div className="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black p-4">
            <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-2xl">
              ...
              <p className="mb-6 leading-relaxed text-gray-600">
                Bạn đang thanh toán để gia hạn tin đăng của mình. Vui lòng xác
                nhận thông tin bên dưới.
              </p>
