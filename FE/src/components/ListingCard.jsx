            ...
            <div className="flex flex-1 flex-col p-6">
              ...
              <div className="mb-3 flex items-start justify-between">
                ...
                <button
                  ...
                  title="Yêu thích"
                >
                  <Heart className="h-5 w-5 bg-white fill-current" />
                </button>
              </div>
              ...
              <Link
                to={`/room/${listing.id}`}
                className="mb-2 line-clamp-2 cursor-pointer text-lg font-bold text-gray-800 hover:text-amber-600"
              >
                {listing.title}
              </Link>
              ...
              <div className="mb-3 flex items-center gap-4 text-sm text-gray-600">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>
                   {listing.district} , {listing.city}</span>
                </div>
              </div>
